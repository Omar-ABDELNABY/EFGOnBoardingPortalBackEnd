...
namespace DAL.Migrations
{
    ...
    [Migration("20190601140021_third")]
    partial class third
    {
            ...
            modelBuilder.Entity("DAL.ApplicationUser", b =>
                {
                    ...
                    b.HasData(
                        new { Id = "f50496fe-8f6f-4e79-8654-87320839f33c", AccessFailedCount = 0, Approval = false, ConcurrencyStamp = "b17aae9d-e95c-4d6e-b98c-3bcac448721b", Deactivated = false, Email = "admin@efg.com", EmailConfirmed = true, ITContact = 0, InitiatorType = 0, LockoutEnabled = false, NormalizedEmail = "ADMIN@EFG.COM", NormalizedUserName = "ADMIN", PasswordHash = "AQAAAAEAACcQAAAAEHrussju52EURDYEoj5QLtvNHkTgeN3cPxeeME9cLxmCLuY6/JQ1nHIy6G9GB2P7gA==", PhoneNumberConfirmed = false, SecurityStamp = "", TraderContact = 0, TwoFactorEnabled = false, UserName = "admin" }
                    );
                });
