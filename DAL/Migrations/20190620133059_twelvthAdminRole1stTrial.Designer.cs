...
namespace DAL.Migrations
{
    ...
    [Migration("20190620133059_twelvthAdminRole1stTrial")]
    partial class twelvthAdminRole1stTrial
    {
            ...
            modelBuilder.Entity("DAL.ApplicationUser", b =>
                {
                    ...
                    b.HasData(
                        new { Id = "1234567890", AccessFailedCount = 0, Approval = false, ConcurrencyStamp = "8e4059d7-28d3-43a4-b792-f33e17becb18", Deactivated = false, Email = "admin@efg.com", EmailConfirmed = true, ITContact = 0, InitiatorType = 0, LockoutEnabled = false, NormalizedEmail = "ADMIN@EFG.COM", NormalizedUserName = "ADMIN", PasswordHash = "AQAAAAEAACcQAAAAEBkyfdInespmRpDyxidRRC1S83FhC6NbKEGVuwO8opfM4z+w+YWQoYcLASwM3PQ8TQ==", PhoneNumberConfirmed = false, SecurityStamp = "", TraderContact = 0, TwoFactorEnabled = false, UserName = "admin" }
                    );
                });
