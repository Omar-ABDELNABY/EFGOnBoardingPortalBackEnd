...
namespace DAL.Migrations
{
    ...
    [Migration("20190626133736_AfterChangeConnection")]
    partial class AfterChangeConnection
    {
            ...
            modelBuilder.Entity("Utilities.ApplicationUser", b =>
                {
                    ...
                    b.HasData(
                        new { Id = "1234567890", AccessFailedCount = 0, Approval = false, ConcurrencyStamp = "5329f73e-0049-4a60-8444-c78ef6f5b5af", Deactivated = false, Email = "admin@efg.com", EmailConfirmed = true, ITContact = 0, LockoutEnabled = false, NormalizedEmail = "ADMIN@EFG.COM", NormalizedUserName = "ADMIN", PasswordHash = "AQAAAAEAACcQAAAAEFFLseQNjQDwXg4s1onKPWh7CYI/0RptINjesB1WTmGVBF5jhhw+Osllf5gvzP8bSw==", PhoneNumberConfirmed = false, SecurityStamp = "", TraderContact = 0, TwoFactorEnabled = false, UserName = "admin" }
                    );
                });
