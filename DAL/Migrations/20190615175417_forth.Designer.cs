...
namespace DAL.Migrations
{
    ...
    [Migration("20190615175417_forth")]
    partial class forth
    {
            ...
            modelBuilder.Entity("DAL.ApplicationUser", b =>
                {
                    ...
                    b.HasData(
                        new { Id = "c2a068d7-889e-4b7e-b668-0a9ecb6c0a3b", AccessFailedCount = 0, Approval = false, ConcurrencyStamp = "09d1618c-328a-445d-8559-e4d2b2549b96", Deactivated = false, Email = "admin@efg.com", EmailConfirmed = true, ITContact = 0, InitiatorType = 0, LockoutEnabled = false, NormalizedEmail = "ADMIN@EFG.COM", NormalizedUserName = "ADMIN", PasswordHash = "AQAAAAEAACcQAAAAEEZL7zJzfXX4m35XiNBdRQGfDR5z04qKKeWoLKpR9BLUEbnjCpOLYY/26bFGp2I/Gg==", PhoneNumberConfirmed = false, SecurityStamp = "", TraderContact = 0, TwoFactorEnabled = false, UserName = "admin" }
                    );
                });
