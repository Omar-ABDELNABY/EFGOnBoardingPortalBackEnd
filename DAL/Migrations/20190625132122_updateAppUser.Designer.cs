...
namespace DAL.Migrations
{
    ...
    [Migration("20190625132122_updateAppUser")]
            ...
            modelBuilder.Entity("Utilities.ApplicationUser", b =>
                {
                    ...
                    b.HasData(
                        new { Id = "1234567890", AccessFailedCount = 0, Approval = false, ConcurrencyStamp = "921060ad-dde0-45b8-a34c-19fa9c7c0407", Deactivated = false, Email = "admin@efg.com", EmailConfirmed = true, ITContact = 0, LockoutEnabled = false, NormalizedEmail = "ADMIN@EFG.COM", NormalizedUserName = "ADMIN", PasswordHash = "AQAAAAEAACcQAAAAEGxG+0Lbb9ZDesErijh/hdrvFnpat5uKPif6OQThKzcBO6LUgLI4+zjKWmuPg0D7lg==", PhoneNumberConfirmed = false, SecurityStamp = "", TraderContact = 0, TwoFactorEnabled = false, UserName = "admin" }
                    );
                });
